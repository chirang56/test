...
{/*Sample product data for demonstration purposes 
    (replace with API or database data) */}
  const products = [
    { id: 1, name: "Chew Toy", description: "Durable toy for teething.", 
    ...
    { id: 5, name: "Pet Shampoo", description: "Gentle and safe shampoo.", 
        imageUrl: "https://via.placeholder.com/150", price: "$15.00" },
    { id: 6, name: "Pet Carrier", description: "Portable and comfortable.", 
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <button
            ...
            bg-orange-500 text-white p-3 rounded-full hover:bg-orange-600 
          ...
          <div
            ...
            {products.map((product) => (
              <div
                key={product.id}
                className="min-w-[279px] bg-white rounded-lg shadow-md 
                ...
                <div className="p-4">
                  ...
                  <button className="mt-4 bg-orange-500 text-white py-2 
                  px-4 rounded hover:bg-orange-600 transition">
                    Add to Cart
                  </button>
                </div>
              </div>
